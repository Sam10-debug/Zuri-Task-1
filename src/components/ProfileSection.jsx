...
const ProfileSection = () => {
  ...
  return (
	<header className="h-[192px] w-full flex justify-center flex-col items-center relative">
		  <svg className='flex md:hidden absolute right-5 top-4' width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect x="1" y="1" width="40" height="40" rx="20" stroke="#D0D5DD" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="1 3"/>
		...
		<input type="hidden" name="Emor_Musk" id='slack' />
