...
const ProfileSection = () => {
  return (
	<header className="h-[192px] w-full flex justify-center flex-col items-center relative">
		...
		<h4 className='twitter-text mt-4 font-bold text-[20px]'>Emor Musk</h4>
		<svg className='flex md:hidden absolute right-0 top-4' width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
